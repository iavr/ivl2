...
template <typename T> using is_enum = expr <__is_enum (T)>;
...
template <typename T> using is_literal = expr <__is_literal (T)>;
...
template <typename T>
using is_std_layout = expr <__is_std_layout (T)>;
...
template <typename T> using is_pod = expr <__is_pod (T)>;
